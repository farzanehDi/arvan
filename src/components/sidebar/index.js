        ...
        <>
            <div className="relative min-h-screen md:flex" data-dev-hint="container">
                ...
                <aside id="sidebar"
                    ...
                    <NavLink to={"/articles"} className={isActive => "py-2.5 pl-8" + (isActive && " bg-white/[.2]")}>All Articles</NavLink>
                </aside>
                ...
                <main id="content" className="flex-1 p-6 lg:px-8">
                    <div className="max-w-8xl mx-auto">
                        ...
                        <div className="px-4  sm:px-0  min-h-96 mt-16">
                            {/*<div className="border-4 border-dashed border-gray-200 rounded-lg h-96 mt-12">*/}
                            {props.children}
                            {/*</div>*/}
                        </div>
